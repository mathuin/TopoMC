...
def building(x, z, elevval, length, width, height, side):
	...
	fillBlocks(right, length, level, 1, back, width, "Stone")
     	...
     	setBlockAt(stairholex4, level, stairholez4, "Stone Stair")
      	setBlockAt(stairholex3, level-1, stairholez3, "Stone Stair")
     	setBlockAt(stairholex2, level-2, stairholez2, "Stone Stair")
     	setBlockAt(stairholex1, level-3, stairholez1, "Stone Stair")
